...
import { AtualizadosProtestoRoutingModule } from './atualizados-protesto-routing.module';
...
@NgModule({
	imports: [
		CommonModule,
		FormsModule,
		AtualizadosProtestoRoutingModule,
		DataViewModule,
		PickListModule,
		OrderListModule,
		InputTextModule,
	...
	declarations: [AtualizadosProtestoComponent],
	providers: [SearchChannelResolver, DatePipe],
})
export class AtualizadosProtestoModule { }
