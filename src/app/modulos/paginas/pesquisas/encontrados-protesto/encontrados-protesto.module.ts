...
import { EncontradosProtestoRoutingModule } from './encontrados-protesto-routing.module';
...
@NgModule({
	imports: [
		CommonModule,
		FormsModule,
		EncontradosProtestoRoutingModule,
		DataViewModule,
		PickListModule,
		OrderListModule,
		InputTextModule,
	...
	declarations: [EncontradosProtestoComponent],
	providers: [SearchChannelResolver, DatePipe],
})
export class EncontradosProtestoModule { }
