...
import { EncontradosProtestadosRoutingModule } from './encontrados-protestados-routing.module';
...
@NgModule({
	imports: [
		CommonModule,
		FormsModule,
		EncontradosProtestadosRoutingModule,
		DataViewModule,
		PickListModule,
		OrderListModule,
		InputTextModule,
	...
	declarations: [EncontradosProtestadosComponent],
	providers: [SearchChannelResolver, DatePipe],
})
export class EncontradosProtestadosModule { }
