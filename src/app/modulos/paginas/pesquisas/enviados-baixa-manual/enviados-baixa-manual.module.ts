...
import { EnviadosBaixaManualRoutingModule } from './enviados-baixa-manual-routing.module';
...
@NgModule({
	imports: [
		CommonModule,
		FormsModule,
		EnviadosBaixaManualRoutingModule,
		DataViewModule,
		PickListModule,
		OrderListModule,
		InputTextModule,
	...
	declarations: [EnviadosBaixaManualComponent],
	providers: [SearchChannelResolver, DatePipe],
})
export class EnviadosBaixaManualModule { }
