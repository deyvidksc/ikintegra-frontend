...
import { EncontradosBaixaManualRoutingModule } from './encontrados-baixa-manual-routing.module';
...
@NgModule({
	imports: [
		CommonModule,
		FormsModule,
		EncontradosBaixaManualRoutingModule,
		DataViewModule,
		PickListModule,
		OrderListModule,
		InputTextModule,
	...
	declarations: [EncontradosBaixaManualComponent],
	providers: [SearchChannelResolver, DatePipe],
})
export class EncontradosBaixaManualModule { }
