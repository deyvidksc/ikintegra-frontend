...
import { EnviadosProtestoRoutingModule } from './enviados-protesto-routing.module';
...
@NgModule({
	...
	declarations: [EnviadosProtestoComponent],
	providers: [SearchChannelResolver, DatePipe],
})
export class EnviadosProtestoModule { }
