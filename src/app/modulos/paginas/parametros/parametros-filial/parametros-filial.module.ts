...
import { ParametrosFilialRoutingModule } from './parametros-filial-routing.module';
...
@NgModule({
	...
	declarations: [ParametrosFilialComponent],
	providers: [SearchChannelResolver, DatePipe],
})
export class ParametrosFilialModule { }
